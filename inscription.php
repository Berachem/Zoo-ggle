<?php
    ...
    if(isset($_POST['login']) && !empty($_POST['login']) && isset($_POST['psw']) &&
        !empty($_POST['psw']) && isset($_POST['mail']) && !empty($_POST['mail']) && isset($_POST['public']) && isset
            ($_POST['desc'])){
        ...
        Connexion::register($_POST['login'],$_POST['psw'],$_POST['mail'],$desc,$_POST['public']);
    }
...
<form action="" method="post">
    ...
    <input type="radio" name="non-public" id="public" value="0"><label for="non-public">PUBLIC</label> <br>
    <input type="submit">
</form>
