  ...
  return (
    <>
      <section className="relative block h-[50vh]">
        <div className="bg-profile-background absolute top-0 h-full w-full bg-[url('https://img.freepik.com/vecteurs-libre/fond-jungle-detaille_23-2148949774.jpg?w=2000')] bg-cover bg-center" />
          ...
          <div className="relative mb-6 -mt-64 flex w-full min-w-0 flex-col break-words rounded-3xl bg-white shadow-xl shadow-gray-500/5">
            <div className="px-6">
              ...
              <div className="my-8 text-center">
                <Typography variant="h2" color="blue-gray" className="mb-2 text-3xl font-semibold">
                  Kylian Mbappé
                </Typography>
                ...
                <div className="mb-2 flex items-center justify-center gap-2">
                  ...
                  <Typography className="font-medium text-blue-gray-700">
                    Châtelet-Les-Halles University
                  </Typography>
                </div>
              </div>
