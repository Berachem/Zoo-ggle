...
<section>
        ...
        <h1 class="text-center">Mes parties</h1>

        <div class="container mt-5 mb-3">
            <div class="row">
                <?php

                $allGamesDetails = getAllGamesPlayedByUser($_SESSION['user']);
                

                foreach ($allGamesDetails as $gameDetails) {
                    $validWordsListByPlayer = getValidWordsListByPlayer($gameDetails->ID_Partie, $_SESSION['user']);
